...
const handleEditProfile = () => {
    window.location.href = `/profile/edit/${user.value.userWtp}`
}
    ...
    >
        ...
        >
            ...
            >
                ...
                <button
                    class="w-6 h-6 rounded-full flex items-center justify-center bg-gray-300/50 hover:bg-gray-300/70 mt-2 absolute bottom-2 right-2"
                    :class="isDarkMode ? 'bg-gray-500/50 hover:bg-gray-500/70' : 'bg-gray-400/60 hover:bg-gray-300/70'"
